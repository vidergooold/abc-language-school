...
def upgrade() -> None:
    ...
    op.execute('DROP TABLE rooms CASCADE')
    ...
    op.execute("ALTER TABLE notifications ALTER COLUMN notification_type TYPE notificationtype USING notification_type::notificationtype")
