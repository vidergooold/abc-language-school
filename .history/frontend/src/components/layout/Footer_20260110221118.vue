  ...
  <footer class="footer">
    <div class="footer__content">
      ...
      <div class="footer__right">
        <iframe
          class="footer__map"
          src="https://yandex.ru/map-widget/v1/?um=constructor%3Aec7d3e8f7c0f4b8f9c0f4b8f9c0f4b8f&amp;source=constructor"
          frameborder="0"
          allowfullscreen
        ></iframe>
        <p class="map-note">
          👆 На карте отмечены все 22 филиала ABC School
        </p>
      </div>
    </div>
    ...
    <details class="footer__branches">
      <summary class="footer__branches-title">
        Все места обучения (22 филиала) — подробно
      </summary>
