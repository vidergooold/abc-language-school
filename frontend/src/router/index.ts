  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'lesson-material', name: 'account-lesson-material', component: AccountLessonMaterial, meta: { requiresAuth: true } },
        { path: 'homework', name: 'account-homework', component: AccountHomework, meta: { requiresAuth: true } },
